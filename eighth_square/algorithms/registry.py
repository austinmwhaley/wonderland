...
STATE_ENVS = [
    ...
    "mountaincar",
    "acrobot",
]  # expose env.state for one-ply lookahead (not box2d)
...
ALGORITHMS = {
    "epsilon_greedy_bandit": _entry(
        ...
        ["exploration vs exploitation", "baseline bandit behavior"],
        ["bandit"],
    ...
    "optimistic_bandit": _entry(
        ...
        ["exploration via optimism", "evaluating exploration mechanisms"],
        ["bandit"],
    ...
    "ucb_bandit": _entry(
        ...
        ["principled exploration", "regret minimization"],
        ["bandit"],
    ...
    "gradient_bandit": _entry(
        ...
        ["preference-based selection", "studying baselines"],
        ["bandit"],
    ...
    "thompson_sampling": _entry(
        ...
        ["Bayesian exploration", "regret minimization"],
        ["bandit"],
    ...
    "policy_evaluation": _entry(
        ...
        ["computing value functions", "model-based planning", "FrozenLake"],
        PLANNING_ENVS,
    ...
    "mc_prediction": _entry(
        ...
        ["learning value functions from episodes", "understanding MC returns"],
        TABULAR_ENVS,
    ...
    "mc_control_onpolicy": _entry(
        ...
        ["episodic tasks", "high-variance but unbiased learning"],
        TABULAR_ENVS,
    ...
    "mc_control_offpolicy": _entry(
        ...
        ["learning greedy policy from exploratory data"],
        TABULAR_ENVS,
    ...
    "td0_prediction": _entry(
        ...
        ["learning with fewer samples than MC"],
        TABULAR_ENVS,
    ...
    "sarsa": _entry(
        ...
        ["classic control", "SARSA vs Q-learning cliff comparison"],
        TABULAR_ENVS,
    ...
    "expected_sarsa": _entry(
        ...
        ["lower-variance updates", "studying bootstrapping"],
        TABULAR_ENVS,
    ...
    "qlearning": _entry(
        ...
        ["classic control", "off-policy learning"],
        TABULAR_ENVS,
    ...
    "double_qlearning": _entry(
        ...
        ["maximization bias", "stochastic environments"],
        TABULAR_ENVS,
    ...
    "td_lambda_prediction": _entry(
        ...
        ["bridging MC and TD", "eligibility traces"],
        TABULAR_ENVS,
    ...
    "nstep_sarsa": _entry(
        ...
        ["tuning bootstrap depth", "unifying TD and MC"],
        TABULAR_ENVS,
    ...
    "nstep_expected_sarsa": _entry(
        ...
        ["lower-variance n-step learning"],
        TABULAR_ENVS,
    ...
    "tree_backup": _entry(
        ...
        ["off-policy control", "clipping-free updates"],
        TABULAR_ENVS,
    ...
    "nstep_off_policy": _entry(
        ...
        ["importance sampling", "off-policy control"],
        TABULAR_ENVS,
    ...
    "sarsa_lambda": _entry(
        ...
        ["trace-based credit assignment", "faster tabular learning"],
        TABULAR_ENVS,
    ...
    "q_lambda": _entry(
        ...
        ["off-policy traces", "greedy trajectories"],
        TABULAR_ENVS,
    ...
    "dyna_q": _entry(
        ...
        ["model-based learning", "sample efficiency"],
        TABULAR_ENVS,
    ...
    "dyna_q_plus": _entry(
        ...
        ["non-stationary environments", "exploration bonus"],
        TABULAR_ENVS,
    ...
    "prioritized_sweeping": _entry(
        ...
        ["efficient planning", "focused backups"],
        TABULAR_ENVS,
    ...
    "reinforce": _entry(
        ...
        ["policy gradients 101", "episodic tasks"],
        BOTH_ENVS,
    ...
    "actor_critic": _entry(
        ...
        ["bootstrapping policy gradients", "continuous control"],
        BOTH_ENVS,
    ...
    "a2c": _entry(
        ...
        ["parallel training", "stabilizing actor-critics"],
        BOTH_ENVS,
    ...
    "ppo": _entry(
        ...
        ["general-purpose RL", "the default modern baseline"],
        BOTH_ENVS,
        "The workhorse of modern RL; robust across seeds and tasks.",
    ),
    "trpo": _entry(
        TRPO,
        "Schulman et al. 2015, arXiv:1502.05477",
        "policy-gradient",
        "on-policy",
        "both",
        "both",
        "Trust region policy optimization: KL-constrained updates via conjugate gradient.",
        ["stable monotonic improvements", "theory-minded experiments"],
        BOTH_ENVS,
    ...
    "dqn": _entry(
        ...
        ["discrete-action deep RL", "Atari-style control"],
        CLASSIC_ENVS,
    ...
    "acktr": _entry(
        ...
        ["curvature-aware updates", "natural gradient RL"],
        CLASSIC_ENVS,
    ...
    "mcts": _entry(
        ...
        ["tree search", "planning with a known model"],
        STATE_ENVS,
    ...
    "alphazero": _entry(
        ...
        ["self-play search", "policy/value-guided MCTS"],
        STATE_ENVS,
    ...
    "muzero": _entry(
        MuZeroAgent,
        "Schrittwieser et al. 2019, Nature",
        "model-based",
        "on-policy",
        "discrete",
        "continuous",
        ...
        ["learned world models", "planning without a model"],
        STATE_ENVS,
    ...
    "world_models": _entry(
        ...
        ["generative world models", "evolutionary control in imagination"],
        CLASSIC_ENVS,
    ...
    "dreamer": _entry(
        ...
        ["recurrent world models", "policy learning in imagination"],
        CLASSIC_ENVS,
    ...
    "mappo": _entry(
        ...
        ["centralized critics", "trust-region policy updates"],
        MARL_ENVS,
    ...
    "qmix": _entry(
        ...
        ["value decomposition", "cooperative MARL"],
        MARL_ENVS,
    ...
    "her": _entry(
        ...
        ["goal-conditioned RL", "sparse-reward learning"],
        ["point_reach"],
    ...
    "icm": _entry(
        ...
        ["sparse-reward exploration", "curiosity-driven learning"],
        CLASSIC_ENVS + TABULAR_ENVS,
        "Inverse model ties the features to actionability; intrinsic reward is std-normalized.",
    ),
    "rnd": _entry(
        RND,
        "Burda et al. 2018, ICLR",
        "value-based",
        "off-policy",
        "discrete",
        "both",
    ...
    "agent57": _entry(
        ...
        ["long-horizon tasks", "exploration/exploitation balance"],
        CLASSIC_ENVS,
    ...
    "cql": _entry(
        ...
        ["offline RL", "safe policy learning from fixed data"],
        CLASSIC_ENVS,
    ...
    "iql": _entry(
        ...
        ["offline RL", "penalty-free conservative value learning"],
        CLASSIC_ENVS,
    ...
    "decision_transformer": _entry(
        ...
        ["offline RL", "sequence-modeling RL"],
        CLASSIC_ENVS,
...
for name, (description, source) in STUBS.items():
    ALGORITHMS[name] = {
        "class": make_stub(
            name, description, source, "discrete", "both", "model-based", "off-policy"
        ),
        "status": "stub",
        "source": source,
        "family": "model-based",
        ...
        "state_space": "both",
        "description": description,
        "use_cases": ["planned", "not yet implemented"],
        "compatible_envs": [],
        "notes": "Stub: registered so the table is complete; running raises NotImplementedError.",
    }
...
def check_compat(algo_name, env_name):
    ...
    if env_name not in algo["compatible_envs"]:
        return False, (
            f"{algo_name} is not listed as compatible with {env_name}. "
            f"Compatible: {algo['compatible_envs'] or 'none yet'}"
        )
    if algo["action_space"] != "both" and algo["action_space"] != env["action_space"]:
        return (
            False,
            f"{algo_name} needs {algo['action_space']} actions but {env_name} has {env['action_space']}",
        )
    if algo["state_space"] != "both" and algo["state_space"] != env["state_space"]:
        return (
            False,
            f"{algo_name} needs {algo['state_space']} states but {env_name} has {env['state_space']}",
        )
    return True, ""
...
def render_table(implemented_only=False):
    ...
    for name, a in sorted(ALGORITHMS.items()):
        ...
        rows.append(
            [
                name,
                "implemented" if a["status"] == "implemented" else "stub",
                a["family"],
                a["policy"],
                a["action_space"],
                a["state_space"],
