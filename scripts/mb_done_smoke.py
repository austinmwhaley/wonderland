...
for name, cand in [('uniform', U()),
                   ('iql(expert)', load_candidate('iql', env, data, cfg, '/home/austin-whaley/wq/white_queen/verdicts/v15/iql_novice_only.pt'))]:
